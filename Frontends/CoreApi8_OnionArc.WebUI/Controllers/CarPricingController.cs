...
using CoreApi8_OnionArc.Dtos.CarPricingDtos;
...
namespace CoreApi8_OnionArc.WebUI.Controllers
{
	public class CarPricingController : Controller
	{
		...
		public async Task<IActionResult> Index()
		{
			...
			var responseMessage = await client.GetAsync("https://localhost:5078/api/CarPricings/GetCarPricingWithTimePeriodList");
