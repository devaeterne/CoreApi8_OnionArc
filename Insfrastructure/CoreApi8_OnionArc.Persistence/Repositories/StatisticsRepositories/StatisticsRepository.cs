...
namespace CoreApi8_OnionArc.Persistence.Repositories.StatisticsRepositories
{
    public class StatisticsRepository : IStatisticsRepository
    {
        ...
        {
            var value = _context.Cars.Where(x => x.Millage <= 1000).Count();
            return value;
        }

        public int GetCarCountByTranmissionIsAuto()
        {
            var value = _context.Cars.Where(x => x.Trasmission == "Otomatik").Count();
            return value;
        }
